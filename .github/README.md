...
[`@aws-sdk/client-application-insights`](https://www.npmjs.com/package/@aws-sdk/client-application-insights/v/3.1124.0).
...
- @aws-sdk/client-application-insights v3.1124.0 - [https://cloud-sdk-builds.github.io/?sdk=client-application-insights&version=3.1124.0](https://cloud-sdk-builds.github.io/?sdk=client-application-insights&version=3.1124.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-insights@3.1124.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WMasobJKjaXKQS3+ANEM92WjbeM8BKGE8EfqHaWXSBBS4MMJzSJc3kovWtrOBQND
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-insights": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-insights@3.1124.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-insights@3.1124.0/index.min.mjs": "sha384-WMasobJKjaXKQS3+ANEM92WjbeM8BKGE8EfqHaWXSBBS4MMJzSJc3kovWtrOBQND"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-application-insights/blob/refs/tags/3.1124.0/LICENSE
```
