...
[`@aws-sdk/client-application-insights`](https://www.npmjs.com/package/@aws-sdk/client-application-insights/v/3.1087.0).
...
- @aws-sdk/client-application-insights v3.1087.0 - [https://cloud-sdk-builds.github.io/?sdk=client-application-insights&version=3.1087.0](https://cloud-sdk-builds.github.io/?sdk=client-application-insights&version=3.1087.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-insights@3.1087.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J0S1MUiaJsznykDAf0rixlqeM0SOeVBiL1LAiEEkD/S+ItNLkgn9iqfVDzbIHLKD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-application-insights": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-insights@3.1087.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-application-insights@3.1087.0/index.min.mjs": "sha384-J0S1MUiaJsznykDAf0rixlqeM0SOeVBiL1LAiEEkD/S+ItNLkgn9iqfVDzbIHLKD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-application-insights/blob/refs/tags/3.1087.0/LICENSE
```
